...
def main():
    parser = argparse.ArgumentParser(description="Retrain GDN with improved hyperparameters")
    parser.add_argument("--data-path", type=str, default="data/carOBD/obdiidata", help="Path to data directory")
    parser.add_argument("--output", type=str, default="anomaly-detection/best_multilabel_gdn_improved.pt", help="Output model path")
